'use strict';
import { defineAnimation, getReduceMotionForAnimation } from 'react-native-reanimated/src/animation/util';
import type {
  AnimationCallback,
  Timestamp,
  Animation,
} from 'react-native-reanimated/src/commonTypes';
import { rubberBandDecay } from 'react-native-reanimated/src/animation/decay/rubberBandDecay';
import { isValidRubberBandConfig } from 'react-native-reanimated/src/animation/decay/utils';
import type {
  DecayAnimation,
  DecayConfig,
  DefaultDecayConfig,
  InnerDecayAnimation,
} from 'react-native-reanimated/src/animation/decay/utils';
import { rigidDecay } from 'react-native-reanimated/src/animation/decay/rigidDecay';
