...
'use strict';
import type { HigherOrderAnimation, StyleLayoutAnimation } from 'react-native-reanimated/src/animation/commonTypes';
import type { ParsedColorArray } from 'react-native-reanimated/src/Colors';
import {
  isColor,
  convertToRGBA,
  ...
  toGammaSpace,
  toLinearSpace,
} from 'react-native-reanimated/src/Colors';
import { ReduceMotion, isWorkletFunction } from 'react-native-reanimated/src/commonTypes';
import type {
  SharedValue,
  AnimatableValue,
  Animation,
...
import type {
  AffineMatrixFlat,
  AffineMatrix,
} from 'react-native-reanimated/src/animation/transformationMatrix/matrixUtils';
import {
  flatten,
  multiplyMatrices,
  scaleMatrix,
...
import { shouldBeUseWeb } from 'react-native-reanimated/src/PlatformChecker';
import type { EasingFunctionFactory } from 'react-native-reanimated/src/Easing';
