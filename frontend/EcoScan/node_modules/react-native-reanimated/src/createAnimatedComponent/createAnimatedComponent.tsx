...
import 'react-native-reanimated/src/layoutReanimation/animationsManager';
import invariant from 'invariant';
import { adaptViewConfig } from 'react-native-reanimated/src/ConfigHelper';
import { findHostInstance } from 'react-native-reanimated/src/platform-specific/findHostInstance';
import { enableLayoutAnimations } from 'react-native-reanimated/src/core';
import { SharedTransition, LayoutAnimationType } from 'react-native-reanimated/src/layoutReanimation';
import type { StyleProps, ShadowNodeWrapper } from 'react-native-reanimated/src/commonTypes';
import { getShadowNodeWrapperFromRef } from 'react-native-reanimated/src/fabricUtils';
import { removeFromPropsRegistry } from 'react-native-reanimated/src/PropsRegistry';
import { getReduceMotionFromConfig } from 'react-native-reanimated/src/animation/util';
import { maybeBuild } from 'react-native-reanimated/src/animationBuilder';
import { SkipEnteringContext } from 'react-native-reanimated/src/component/LayoutAnimationConfig';
import type { AnimateProps } from 'react-native-reanimated/src/helperTypes';
import JSPropsUpdater from 'react-native-reanimated/src/createAnimatedComponent/JSPropsUpdater';
import type {
  ...
  NestedArray,
} from 'react-native-reanimated/src/createAnimatedComponent/commonTypes';
import { flattenArray } from 'react-native-reanimated/src/createAnimatedComponent/utils';
import setAndForwardRef from 'react-native-reanimated/src/createAnimatedComponent/setAndForwardRef';
import { isFabric, isJest, isWeb, shouldBeUseWeb } from 'react-native-reanimated/src/PlatformChecker';
import { InlinePropManager } from 'react-native-reanimated/src/createAnimatedComponent/InlinePropManager';
import { PropsFilter } from 'react-native-reanimated/src/createAnimatedComponent/PropsFilter';
import {
  ...
  saveSnapshot,
} from 'react-native-reanimated/src/layoutReanimation/web';
import { updateLayoutAnimations } from 'react-native-reanimated/src/UpdateLayoutAnimations';
import type { CustomConfig } from 'react-native-reanimated/src/layoutReanimation/web/config';
import type { FlatList, FlatListProps } from 'react-native';
import { addHTMLMutationObserver } from 'react-native-reanimated/src/layoutReanimation/web/domUtils';
import { getViewInfo } from 'react-native-reanimated/src/createAnimatedComponent/getViewInfo';
import { NativeEventsManager } from 'react-native-reanimated/src/createAnimatedComponent/NativeEventsManager';
import type { ReanimatedHTMLElement } from 'react-native-reanimated/src/js-reanimated';
import { ReanimatedError } from 'react-native-reanimated/src/errors';
