'use strict';
import type { RubberBandDecayConfig, InnerDecayAnimation } from 'react-native-reanimated/src/animation/decay/utils';
import { SLOPE_FACTOR, VELOCITY_EPS } from 'react-native-reanimated/src/animation/decay/utils';
